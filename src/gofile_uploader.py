        ...
        try:
            ...
            if download_link and file_id:
                ...
                if not args.quiet:
                    ...
                    print(f"├{'─' * 58}┤")
                    print(f"│ {'File:':<12} {os.path.basename(file_path):<44} │")
                    if args.category:
                        print(f"│ {'Category:':<12} {args.category:<44} │")
                    print(f"│ {'Size:':<12} {response_data.get('file_size_formatted', ''):<44} │")
                    print(f"│ {'Speed:':<12} {response_data.get('speed_formatted', ''):<44} │")
                    print(f"│ {'Expires:':<12} {expiry_date.strftime('%Y-%m-%d'):<44} │")
                    print(f"├{'─' * 58}┤")
                    print(f"│ {BLUE}{download_link}{END}")
                    print(f"└{'─' * 58}┘")
            else:
                logger.warning(
