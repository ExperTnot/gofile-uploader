...
class TestCategoryOperations:
    ...
    def test_list_categories(self, temp_db):
        ...
        temp_db.save_folder_for_category("cat1", {"folder_id": "f1", "folder_code": "c1"})
        temp_db.save_folder_for_category("cat2", {"folder_id": "f2", "folder_code": "c2"})
    ...
    def test_remove_category(self, temp_db):
        ...
        temp_db.save_folder_for_category("to_remove", {"folder_id": "f1", "folder_code": "c1"})
...
class TestFileOperations:
    ...
    def test_get_files_by_category(self, temp_db):
        ...
        temp_db.save_file_info({
            "id": "f1", "name": "a.txt", "download_link": "link1",
            "folder_id": "f1", "category": "docs"
        })
        temp_db.save_file_info({
            "id": "f2", "name": "b.txt", "download_link": "link2",
            "folder_id": "f1", "category": "images"
        })
        temp_db.save_file_info({
            "id": "f3", "name": "c.txt", "download_link": "link3",
            "folder_id": "f1", "category": "docs"
        })
    ...
    def test_get_file_count_by_category(self, temp_db):
        ...
        temp_db.save_file_info({
            "id": "f1", "name": "a.txt", "download_link": "l1",
            "folder_id": "f1", "category": "cat_a"
        })
        temp_db.save_file_info({
            "id": "f2", "name": "b.txt", "download_link": "l2",
            "folder_id": "f1", "category": "cat_a"
        })
        temp_db.save_file_info({
            "id": "f3", "name": "c.txt", "download_link": "l3",
            "folder_id": "f1", "category": "cat_b"
        })
...
class TestContextManager:
    ...
    def test_context_manager(self):
        ...
        with DatabaseManager(path) as db:
            db.save_folder_for_category("test", {"folder_id": "f1", "folder_code": "c1"})
...
class TestEdgeCases:
    ...
    def test_unicode_category_name(self, temp_db):
        ...
        temp_db.save_folder_for_category("日本語カテゴリ", {"folder_id": "f1", "folder_code": "c1"})
    ...
    def test_special_characters_in_category(self, temp_db):
        ...
        temp_db.save_folder_for_category("cat-with_special.chars", {"folder_id": "f1", "folder_code": "c1"})
    ...
    def test_category_update(self, temp_db):
        ...
        temp_db.save_folder_for_category("update_cat", {"folder_id": "old_id", "folder_code": "old_code"})
        temp_db.save_folder_for_category("update_cat", {"folder_id": "new_id", "folder_code": "new_code"})
