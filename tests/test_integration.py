...
class TestDatabaseIntegration:
    ...
    def test_multiple_files_same_category(self, temp_db):
        ...
        temp_db.save_folder_for_category("multi", {"folder_id": "f1", "folder_code": "c1"})
...
class TestDataConsistency:
    ...
    def test_file_category_relationship(self, temp_db):
        ...
        # Create category
        temp_db.save_folder_for_category("docs", {"folder_id": "f1", "folder_code": "c1"})
        
        # Add files to category
        temp_db.save_file_info({
            "id": "f1", "name": "doc1.txt", "download_link": "l1",
            "folder_id": "f1", "category": "docs"
        })
        temp_db.save_file_info({
            "id": "f2", "name": "doc2.txt", "download_link": "l2",
            "folder_id": "f1", "category": "docs"
        })
    ...
    def test_orphaned_files_detection(self, temp_db):
        ...
        temp_db.save_folder_for_category("temp_cat", {"folder_id": "f1", "folder_code": "c1"})
        temp_db.save_file_info({
            "id": "orphan1", "name": "file.txt", "download_link": "l1",
            "folder_id": "f1", "category": "temp_cat"
        })
